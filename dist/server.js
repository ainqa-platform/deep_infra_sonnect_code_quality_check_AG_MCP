...
server.tool("code_quality_check", "Analyze code quality of a local file using DeepInfra LLM. Returns a structured review covering readability, maintainability, bugs, security, refactoring suggestions, and anti-patterns.", {
    filePath: z
        .string()
...
server.tool("code_quality_config", "Show current DeepInfra code quality MCP configuration (model, base URL, code root, max file size).", {}, async () => {
    return {
        content: [
            {
                type: "text",
